...
class PrefixNode final : public IMaybeStatementASTNode {
  public:
    static constexpr ASTNodeKind kKind = ASTNodeKind::Prefix;

    PrefixNode(Lexer::IToken* NearbyTokenIn, IAssignableASTNode* ExpressionIn, bool IsIncrementIn)
    ...
    static PrefixNode* Parse(Parser::ParseContext& Context, Lexer::TokenOperator* Token, bool IsIncrement);
