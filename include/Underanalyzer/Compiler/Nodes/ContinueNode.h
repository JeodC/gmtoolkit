...
class ContinueNode final : public IASTNode {
  public:
    static constexpr ASTNodeKind kKind = ASTNodeKind::Continue;

    explicit ContinueNode(Lexer::IToken* NearbyTokenIn) : _NearbyToken(NearbyTokenIn) {
    }
